...
class bpModActions extends bpModeration
{
	...
	function send_warning(&$cont, $flag_count)
	{
		...
		$subject = "[$sitename] " . __('One of your activity updates has been reported by a site member', 'bp-moderation');
		...
		if ($this->options['warning_forward']) {
			$admin_subject = "[$sitename] " . sprintf(__('A warning for a reported activity update has been sent to %s', 'bp-moderation'), $author_name);
